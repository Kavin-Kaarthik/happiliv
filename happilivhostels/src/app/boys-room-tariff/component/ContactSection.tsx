      ...
      <div className="relative z-10 max-w-7xl w-full px-6 md:px-16 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        >
          ...
          <h2 className="text-3xl font-semibold text-white mb-2">
            <span className="text-blue-500">Send</span> Us A Message
          </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="cursor-pointer w-full bg-blue-700 hover:bg-blue-800 transition text-white font-semibold py-3 rounded-full disabled:opacity-50"
            >
