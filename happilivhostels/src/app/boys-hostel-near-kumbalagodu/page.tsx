...
export const metadata: Metadata = {
  ...
  description:
    "Looking for a boys hostel near Kumbalagodu? HappiLiv Hostels offers safe, affordable, and fully furnished accommodation with food, WiFi, and modern amenities for students.",
};

export default function BoysHostelKumbalagodu() {
  return (
    <>
      <Banner />
      ...
      <section className="px-6 md:px-16 py-12 space-y-12">
        ...
        <div>
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            HappiLiv Hostels offers comfortable and affordable accommodation for
            students searching for a boys hostel near Kumbalagodu.
          </p>

          <p className="text-gray-600 leading-relaxed">
            Our hostel provides a secure and student-friendly environment with
