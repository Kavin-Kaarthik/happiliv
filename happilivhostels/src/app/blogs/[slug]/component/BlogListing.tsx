        ...
        <section className="max-w-7xl mx-auto md:px-15 py-10">
            ...
            >
                ...
                <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <div className="w-full md:w-[30%] relative h-[300px] md:h-[450px] rounded-xl overflow-hidden flex-shrink-0">
                        <Image
                            src={initialData.mainImage2 || initialData.bannerImage}
                            alt={initialData.mainImageAlt2 || initialData.blogName}
                            fill
                            className="object-cover"
                            priority
                        />
