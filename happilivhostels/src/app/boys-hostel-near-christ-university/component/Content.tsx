...
export default function ContentSection() {
    ...
    return (
        ...
        >
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 items-center gap-3 md:gap-8">
                    ...
                    >
                        <h1 className="text-xl md:text-3xl font-semibold mb-4">
                            Best Boys HOSTEL Near Christ University, Bangalore
                        </h1>
                        <p className="text-gray-600 text-[15px] leading-relaxed">
                            HappiLiv Hostels For Boys Near Christ University Offers An Ideal
            ...
            <motion.section
                className="px-6 md:px-12 md:py-12 py-6"
                variants={containerVariants}
            >
                <div className="grid grid-cols-1 md:grid-cols-12 items-center gap-3 md:gap-8">
                    <motion.div
                    ...
                    >
                        ...
                        <p className="text-gray-600 text-[15px] leading-relaxed">
                            ...
                            Interiors, Modern Infrastructure, And 24/7 Security, HappiLiv
                            Hostels Creates A Supportive Living Space Where Residents Can Focus
